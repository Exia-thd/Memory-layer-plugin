---
description: Explain why a file or symbol is the way it is
---

Explain the reasoning behind: $ARGUMENTS

1. Call `memory_why` with that file path or symbol.
...
3. Use `memory_neighbors` on any decision worth tracing, to pick up what it
